/** AAC-LC encoder tables (ISO/IEC 14496-3), values from ffmpeg aactab.c. */

export const AAC_SAMPLE_RATES: readonly number[] = [96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350];

const SWB_96: Uint16Array = Uint16Array.from([
...
const SWB_64: Uint16Array = Uint16Array.from([
    0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 64,
...
const SWB_48: Uint16Array = Uint16Array.from([
...
const SWB_32: Uint16Array = Uint16Array.from([
    0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 48, 56, 64, 72, 80,
    88, 96, 108, 120, 132, 144, 160, 176, 196, 216, 240, 264, 292, 320, 352, 384,
    416, 448, 480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832, 864, 896,
    928, 960, 992, 1024,
]);
const SWB_24: Uint16Array = Uint16Array.from([
...
const SWB_16: Uint16Array = Uint16Array.from([
...
const SWB_8: Uint16Array = Uint16Array.from([
...
/** Scalefactor band offsets (1024-sample long windows) per sampling_frequency_index. */
export const SWB_OFFSET_1024: readonly Uint16Array[] = [SWB_96, SWB_96, SWB_64, SWB_48, SWB_48, SWB_32, SWB_24, SWB_24, SWB_16, SWB_16, SWB_16, SWB_8, SWB_8];

/** Scalefactor huffman: index = dpcm + 60. */
export const SF_HUFF_BITS: Uint8Array = Uint8Array.from([
...
export const SF_HUFF_CODES: Uint32Array = Uint32Array.from([
...
const BOOK1: SpectralBook = {
    dim: 4, lav: 1, range: 3, signed: true,
...
const BOOK3: SpectralBook = {
    dim: 4, lav: 2, range: 3, signed: false,
    codes: Uint16Array.from([
...
const BOOK5: SpectralBook = {
    dim: 2, lav: 4, range: 9, signed: true,
    codes: Uint16Array.from([
...
const BOOK7: SpectralBook = {
    dim: 2, lav: 7, range: 8, signed: false,
    codes: Uint16Array.from([
...
const BOOK9: SpectralBook = {
    dim: 2, lav: 12, range: 13, signed: false,
    codes: Uint16Array.from([
...
const BOOK11: SpectralBook = {
    dim: 2, lav: 16, range: 17, signed: false,
    codes: Uint16Array.from([
...
/** Spectral huffman books 1..11 (index 0 unused). */
export const SPECTRAL_BOOKS: readonly (SpectralBook | null)[] = [null, BOOK1, BOOK2, BOOK3, BOOK4, BOOK5, BOOK6, BOOK7, BOOK8, BOOK9, BOOK10, BOOK11];
